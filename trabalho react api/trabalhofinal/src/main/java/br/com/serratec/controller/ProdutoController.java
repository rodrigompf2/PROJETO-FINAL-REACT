...
public class ProdutoController {
	...
	public ResponseEntity<Page<ProdutoResponseDTO>> listarPorPagina(@PageableDefault(page = 0, size = 3, sort = "valor", direction = Direction.ASC)
			Pageable pageable) {
	...
	@PostMapping
	public ResponseEntity<ProdutoResponseDTO> inserir (@Valid @RequestBody ProdutoRequestDTO produtoRequestDTO) throws DataConflictException {
